...
public class login_agents extends AppCompatActivity {

    EditText t1,t2,t3;
    TextView tv;
    private final String url="http://192.168.211.232/android/db_insert.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_login_agents);
    ...
    public void openActivity2(){
        Intent intent = new Intent(this,agents_profile.class);
